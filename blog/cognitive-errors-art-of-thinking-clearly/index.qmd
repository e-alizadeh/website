...
The brain seeks patterns, coherence, and order where none really exists. As per this cognitive bias, we are oversensitive to finding a structure or rule. The human’s false pattern recognition is also known as [apophenia](https://en.wikipedia.org/wiki/Apophenia). 
...
![abc](img/wikipedia_Martian_face_viking_cropped.png)
...
![Confirmation bias](img/ConfirmationBias.png)
...
![Does the consumption of mozzarella cheese actually lead to more civil engineering PhDs awarded? (Graph: [TylerVigen.com](http://tylervigen.com/), Data sources: [U.S. Department of Agriculture](https://www.census.gov/compendia/statab/2012/tables/12s0217.xls) and [National Science Foundation](https://www.nsf.gov/statistics/infbrief/nsf11305/))](img/FalseCausality_Correlation.png)
