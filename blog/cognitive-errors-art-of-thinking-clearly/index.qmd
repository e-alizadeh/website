...
Created: March 4, 2021 8:14 PM
Last Updated: February 25, 2021
Last updated: September 7, 2022 10:13 PM
Reading Time: 9 min read
Show on Homepage?: No
Tags: Book, Cognitive Bias, Data Science, Decision-Making, Psychology, Self-Improvement
id: 6

![https://ealizadeh.com/wp-content/uploads/2020/11/BP06_Featured_Image.png](https://ealizadeh.com/wp-content/uploads/2020/11/BP06_Featured_Image.png)
...
I have created a graph network showing the connections among these cognitive errors. An interactive network graph on all 98 cognitive errors mentioned in the book can be found [here](https://ealizadeh.com/assets/98-cognitive-errors/). However, since that’s overwhelming and many of them are not directly related to this article, I have also created the network graph of all biases explained in this article and a few more below.

[https://codepen.io/e-alizadeh/pen/dyOjJYG](https://codepen.io/e-alizadeh/pen/dyOjJYG)

# Cognitive Biases

The cognitive error refers to any systematic (not occasional) deviation from the logic[[1]](15%20Cognitive%20Errors%20Every%20Analyst%20Must%20Know%20(+%20Net%20f46d78a24d414957a827ce730e6076a4.md). Let’s go over the interesting ones (in no particular order) below.
...
Most people will bet on Option 2 (the wrong option). The number of truck drivers in Germany is 10,000 times more than the number of literature professors in Frankfurt. Hence, it’s more likely that Mark is a truck driver[[1]](15%20Cognitive%20Errors%20Every%20Analyst%20Must%20Know%20(+%20Net%20f46d78a24d414957a827ce730e6076a4.md).
...
Confirmation bias is the tendency to interpret new information based on our existing beliefs and discard any opposing evidence (disconfirming evidence). The internet is the main ground for this bias. Think about the YouTube video suggestions made to us based on our watch history. It gives us recommendations to videos that align with our current views/beliefs/theories. We are actually prone to confirmation bias in many platforms that use [Recommender systems](https://en.wikipedia.org/wiki/Recommender_system) like Google, Facebook, Twitter, *etc*.

## 4. Overconfidence Effect

This cognitive bias tells us that we systematically overestimate our ability to predict. In other words, this bias says that we believe subjectively that our judgment is better than it objectively is[1]. No wonder why most major projects are not completed in less time or cheaper than initially predicted. The overconfidence bias is more common among experts. The reason is that experts obviously know more about their own field, but they overestimate exactly how much more.
...
Mainly used in medical research studies, the [**intention-to-treat (ITT) principle**](https://www.verywellhealth.com/understanding-intent-to-treat-3132805) is crucial in interpreting the results of randomized clinical trials. It helps the researchers to assess the true effect of choosing a medical treatment. Let’s have an example to understand this fallacy better.
...
![Does the consumption of mozzarella cheese actually lead to more civil engineering PhDs awarded? (Graph: [TylerVigen.com](http://tylervigen.com/), Data sources: [U.S. Department of Agriculture](https://www.census.gov/compendia/statab/2012/tables/12s0217.xls) and [National Science Foundation](https://www.nsf.gov/statistics/infbrief/nsf11305/))](15%20Cognitive%20Errors%20Every%20Analyst%20Must%20Know%20(+%20Net%20f46d78a24d414957a827ce730e6076a4/Untitled%202.png)

Does the consumption of mozzarella cheese actually lead to more civil engineering PhDs awarded? (Graph: [TylerVigen.com](http://tylervigen.com/), Data sources: [U.S. Department of Agriculture](https://www.census.gov/compendia/statab/2012/tables/12s0217.xls) and [National Science Foundation](https://www.nsf.gov/statistics/infbrief/nsf11305/))
...
The majority will go with bag A. Now, let’s repeat the experiment, and this time if you pull a black marble from a bag, you will win $100. In this case, the majority will pick bag A too. This illogical result is known as [**Ellsberg Paradox**](https://en.wikipedia.org/wiki/Ellsberg_paradox), stating that people prefer known probabilities over unknown (ambiguous) ones[[1]](15%20Cognitive%20Errors%20Every%20Analyst%20Must%20Know%20(+%20Net%20f46d78a24d414957a827ce730e6076a4.md). We should be aware of the difference between risks and uncertainties. These two terms are used interchangeably. However, there is a significant difference between the two.
...
## 14. D*é*formation Professionnelle

> If your only tool is a hammer, all your problems will be nails.  —Mark Twain
> 

This fallacy is in place when you view things from one’s own profession instead of a broader perspective. This may impact anyone who learns something new and uses that in every situation. Let’s say you just learned about a new machine learning model. You may use it in cases that better models are available. I actually did the same. During my studies, I learned about [**support vector machine (SVM)**](https://en.wikipedia.org/wiki/Support_vector_machine) (a binary classifier). Whenever I had a classification problem, I would initially think of using SVM, even in multiclass classification for which SVM may not be the best option to start for.
...
[2] Wikipedia. [Base rate fallacy](https://en.wikipedia.org/wiki/Base_rate_fallacy#False_positive_paradox)

[3] Beitman BD. [Brains Seek Patterns in Coincidences](https://doi.org/10.3928/00485713-20090421-02). *Psychiatric Annals*. (2009), 39(5):255-264.

[4] Catalogue of bias collaboration, [Information Bias](https://catalogofbias.org/biases/information-bias/) (2019), Sackett Catalogue Of Biases
...
[Blog Posts](15%20Cognitive%20Errors%20Every%20Analyst%20Must%20Know%20(+%20Net%20f46d78a24d414957a827ce730e6076a4/Blog%20Posts%2067dce63d42e64a7aaf43a978a1391263.csv)

**➡️   Next Post**

[Blog Posts](15%20Cognitive%20Errors%20Every%20Analyst%20Must%20Know%20(+%20Net%20f46d78a24d414957a827ce730e6076a4/Blog%20Posts%200c9ab65e1b5242249090a63b41111b0f.csv)