...
Created: June 21, 2021 11:09 PM
Last Updated: June 27, 2021
Last updated: September 7, 2022 10:13 PM
Reading Time: 6 min read
Show on Homepage?: No
Tags: Database, Guide to, Python
id: 13
...
You can [signup](https://signup.heroku.com/) for free to Heroku. After signing up and logging into your account, you will be directed to the Heroku Dashboard. Then, you can follow the instructions in the following clip to create a new app and add a PostgreSQL database.  

[Deploy a new Heroku app and add the PostgreSQL driver](Step-by-Step%20Deployment%20of%20a%20Free%20PostgreSQL%20Datab%20c6565be042204579af1564b8f7be1c3f/heroku_deploy_app.mp4)

Deploy a new Heroku app and add the PostgreSQL driver
...
<aside>
⚠️ Note: In the free plan, the database credentials will occasionally change since Heroku rotates credentials periodically and sometimes perform maintenances.
...
![Create a Heroku API token from Heroku dashboard](Step-by-Step%20Deployment%20of%20a%20Free%20PostgreSQL%20Datab%20c6565be042204579af1564b8f7be1c3f/heroku_token_generation_web-app.png)
...
![Generate Heroku API token via Heroku CLI](Step-by-Step%20Deployment%20of%20a%20Free%20PostgreSQL%20Datab%20c6565be042204579af1564b8f7be1c3f/heroku_token_generation_cli.png)

Generate Heroku API token via Heroku CLI
...
We can use Python's standard library [subprocess](https://docs.python.org/3/library/subprocess.html) to run above command and retrieve the database credentials. This way we will have all our codes in Python!
...
<aside>
⚠️ **Caution:** Your Python (iPython) terminal/environment should have `HEROKU_API_KEY` set. You can verify that by running `os.environ["HEROKU_API_KEY"]` and verifying the token in the output.
...
You can run raw SQL queries using SQLAlchemy’s `[.execute(“SQL Query”)](https://docs.sqlalchemy.org/en/14/core/engines.html#sqlalchemy.create_engine)` function. For instance, if you want to drop the above table by running a SQL query, you can do so by doing the following: 
...
[Blog Posts](Step-by-Step%20Deployment%20of%20a%20Free%20PostgreSQL%20Datab%20c6565be042204579af1564b8f7be1c3f/Blog%20Posts%20afb049f09f594a75a9a285db93b2650c.csv)

**➡️   Next Post**

[Blog Posts](Step-by-Step%20Deployment%20of%20a%20Free%20PostgreSQL%20Datab%20c6565be042204579af1564b8f7be1c3f/Blog%20Posts%20f378ddb4481141b3941bf081929ea85f.csv)