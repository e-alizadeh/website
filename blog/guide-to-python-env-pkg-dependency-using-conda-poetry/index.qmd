...
Then, we will go over an ideal setup (of course, in my opinion 🙂) suitable for most Python projects using [conda](https://conda.io/) and [Poetry](https://python-poetry.org/).
...
⚠️ Although not recommended, there is also a pip version of Poetry that you can install (`pip install poetry`). 
...
From above figure, you can see that the blue-font package names (requests and pytest) are explicitly added to `pyproject.toml` file. 
